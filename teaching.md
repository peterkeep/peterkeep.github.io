...
<div style="position: relative; margin-top:50px; margin-bottom:100px;">
    ...
    align: center;
    margin: auto;">
        <a href="https://www.discovercalculus.com" target="_blank"><img src="{{ 'assets/img/DCcover.png' | relative_url }}" alt="Discover Calculus" width="200px"/></a>
    </div>
    <div style="margin-left: 210px; padding-left: 10px;">
        <p>
            ...
            <ul>
                ...
                <li>
                    <a href="https://github.com/peterkeep/CalculusOER" target="_blank">Source on GitHub</a>
                </li>
            </ul>
        </p>
    </div>
...
<div style="position: relative; margin-top:100px; margin-bottom:100px;">
    <div style="width: 200px;
    position: absolute;
    top: 0;
    left: 0;
    align: center;
    margin: auto;">
        <a href="https://www.peter-keep.com/StatsProject/web/" target="_blank"><img src="{{ 'assets/img/statscover.png' | relative_url }}" alt="Statistics Lab Book & Project" width="200px"/></a>
    </div>
    <div style="margin-left: 210px; padding-left: 10px;">
        <p>
            ...
            <ul>
                ...
                <li>
                    <a href="https://github.com/peterkeep/StatsProject" target="_blank">Source on GitHub</a>
                </li>
            </ul>
        </p>
    </div>
